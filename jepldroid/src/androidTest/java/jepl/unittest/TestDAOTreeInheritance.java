...
*/
package jepl.unittest;

import jepl.example.CreateDBModel;
import jepl.example.DataSourceFactoryOfLoaderJDBC;
import jepl.example.DataSourceLoader;
import jepl.example.dao.CompanyDAO;
import jepl.example.dao.ContactDAO;
import jepl.example.dao.ContactTreeDAO;
import jepl.example.dao.PersonDAO;
import jepl.example.loadmanually.DataSourceLoaderManualLoad;
import jepl.example.model.Company;
import jepl.example.model.Contact;
import jepl.example.model.Person;
import java.util.List;
import javax.sql.DataSource;
import jepl.*;
import static org.junit.Assert.assertTrue;
import org.junit.*;
import jepl.unittest.shared.TestDAOShared;
